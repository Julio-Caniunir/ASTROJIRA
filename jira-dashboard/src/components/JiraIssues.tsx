...
export default function JiraIssues() {
  ...
  const previousRedIssuesCount = useRef<number | null>(null);
  ...
  useEffect(() => {
    const currentRedIssuesCount = redIssues.length;

    if (isInitialMount.current) {
      previousRedIssuesCount.current = currentRedIssuesCount;
      isInitialMount.current = false;
      return;
    }

    if (previousRedIssuesCount.current !== null && currentRedIssuesCount > previousRedIssuesCount.current) {
      const audio = new Audio("data:audio/mpeg;base64,-
